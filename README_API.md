...
4. [Gestion des réunions - Endpoints standard](#gestion-des-réunions---endpoints-standard)
5. [Gestion des réunions - Endpoints simplifiés](#gestion-des-réunions---endpoints-simplifiés)
...
## Gestion des réunions - Endpoints standard
...
[
  ...
  {
    "id": "1e65495c-4c13-4ac4-aa0d-fe6dea5ba3da",
    "user_id": "99dfd97f-a65a-4881-b917-318254285727",
    "title": "test_audio.mp3",
    "file_url": "/uploads/99dfd97f-a65a-4881-b917-318254285727/20250305_165532_tmprgwvcw1v.mp3",
    "transcript_text": "",
    "transcript_status": "completed",
    "created_at": "2025-03-05T16:55:32.988411",
    "duration_seconds": 6,
    "speakers_count": null,
    "transcription_status": "completed"
  }
...
**Description :**
Cet endpoint déclenche la génération d'un compte rendu de réunion à partir de la transcription existante. La génération s'effectue de manière asynchrone en utilisant l'API Mistral. La transcription doit être complète (`transcript_status` = "completed") pour pouvoir générer un compte rendu.
...
**Description :**
Cet endpoint permet de récupérer le compte rendu généré pour une réunion spécifique ainsi que son statut. Le statut peut être l'un des suivants :
- `processing` : La génération du compte rendu est en cours
- `completed` : Le compte rendu a été généré avec succès
- `error` : Une erreur s'est produite lors de la génération du compte rendu

**Réponse :**
```json
{
  "meeting_id": "8bddab9d-5942-4b70-8921-9e391f165a45",
  "summary_text": "# Synthèse\nLa réunion a porté sur l'ouverture d'une séance du Conseil, avec la désignation d'une secrétaire de séance, l'accueil de nouveaux élus, et la lecture des déports pour diverses délibérations.\n\n# Éléments discutés\n- Désignation de Mme Piccard comme secrétaire de séance\n- Accueil de deux nouveaux élus : Delphine de Verneuil et Franck Quémone\n- Lecture des déports pour différentes délibérations\n- Approbation des procès-verbaux des séances de juin et de juillet\n- Discussion sur un marché passé pour une œuvre d'art dans le quartier Est\n\n# Relevé de décisions\n- Mme Piccard a été désignée secrétaire de séance à l'unanimité\n- Les procès-verbaux des séances de juin et de juillet ont été adoptés\n- Les comptes-rendus des décisions prises et des marchés passés ont été approuvés\n\n# Plan d'action\n- Installation d'une œuvre d'art à l'entrée de la fontaine de l'étuvée dans le cadre d'un projet du budget participatif",
...
Les endpoints simplifiés offrent une interface plus simple pour interagir avec l'API, avec des vérifications automatiques des statuts de transcription.
